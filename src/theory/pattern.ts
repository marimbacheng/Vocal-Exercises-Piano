...
export type Pattern = {
  ...
  name: string;
  notes: Note[];
  /** 三連音音型:結尾收在三連音節奏、換 key 只放一拍新調提示和弦(見 plan.ts) */
  triplet?: boolean;
};
...
export const PATTERNS: Array<Pattern & { dsl: string }> = [
  ...
  // 八度頂音重複系列:三連音(每組 1-3-5 / 8-8-8 / 8-5-3 各佔一拍、每音 1/3 拍),
  // 結尾在三連音節奏收束(1:2/3 拍 + 1:1/3 拍);升 key 由 triplet 旗標交給 plan.ts
  {
    id: 'oct-rep4',
    name: '八度頂音重複 ×4',
    triplet: true,
    dsl: '1:0.33333 3:0.33333 5:0.33333 8:0.33333 8:0.33333 8:0.33333 8:0.33333 5:0.33333 3:0.33333 1:0.66666 1:0.33333',
  },
  {
    id: 'oct-hold',
    name: '八度頂音長音',
    triplet: true,
    dsl: '1:0.33333 3:0.33333 5:0.33333 8 8 8:0.33333 5:0.33333 3:0.33333 1:0.66666 1:0.33333',
  },
  {
    id: 'oct-rep7',
    name: '八度頂音重複 ×7',
    triplet: true,
    dsl: '1:0.33333 3:0.33333 5:0.33333 8:0.33333 8:0.33333 8:0.33333 8:0.33333 8:0.33333 8:0.33333 8:0.33333 5:0.33333 3:0.33333 1:0.66666 1:0.33333',
  },

  { id: 'fifth-lhl', name: '五度跳',   dsl: '1 5 1' },
  { id: 'unison-x3', name: '八度大跳', dsl: '1 8 1' },

  // 延伸琶音音階(三連音),1/2 倍速:每音 2/3 拍;結尾在三連音節奏收束(長短:1:4/3 拍 + 1:2/3 拍)
  {
    id: 'ext-13',
    name: '延伸琶音音階',
    triplet: true,
    dsl: '1:0.66666 3:0.66666 5:0.66666 8:0.66666 10:0.66666 12:0.66666 11:0.66666 9:0.66666 7:0.66666 5:0.66666 4:0.66666 2:0.66666 1:1.33333 1:0.66666',
  },
